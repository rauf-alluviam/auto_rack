...
socket.on('orderPlaced', (order) => {
  ...
  showToast(`New order received from ${order.customerName || 'a customer'}!`);
  ...
  setDashboardData(prevData => {
    ...
    const newNotification = {
      id: Date.now(),
      title: "New Order Received",
      message: `Order from ${order.customerName || 'Customer'} - Qty: ${order.quantity || 1}, Size: ${order.size || 'N/A'}`,
      time: "Just now",
      type: "order" as const,
    };
 ...
 const refreshData = async () => {
  ...
  try {
    ...
    // Don't automatically fall back to mock data on refresh
  } finally {
    setLoading(false)
  }
}
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
              ...
              <div>
                <h1 className="text-lg lg:text-2xl font-bold bg-gradient-to-r from-gray-900 to-blue-700 bg-clip-text text-transparent">
                  AutoRack
                </h1>
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 z-50">
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      {dashboardData.notifications.map((notification) => (
                        <div
                          key={notification.id}
                          className="p-3 hover:bg-white/60 border-b border-gray-100 last:border-b-0 transition-colors"
                        >
      ...
      {/* Error Banner */}
      {error && (
        <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-800 p-4 mx-4 lg:mx-6 mt-4 rounded-r-lg">
          <div className="flex">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-6 lg:mb-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-xl rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <div className={`${stat.bgColor} p-3 lg:p-4 rounded-xl lg:rounded-2xl border ${stat.borderColor}`}>
              ...
              >
                <div className="flex flex-col h-full">
                  <div className="flex items-center justify-between mb-4 lg:mb-6">
                    <div
                      className={`${card.iconBg} p-3 lg:p-4 rounded-xl lg:rounded-2xl shadow-2xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                    >
                  ...
                  <p className="text-gray-600 text-sm lg:text-base leading-relaxed flex-grow">{card.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-8 lg:py-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 lg:space-y-3 text-sm">
                ...
                <li>
                  <a href="/seller/orders" className="text-gray-300 hover:text-white transition-colors hover:underline">
                    Order Management
                  </a>
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 lg:space-y-3 text-sm">
                <li>
                  <a href="/help" className="text-gray-300 hover:text-white transition-colors hover:underline">
                    Help Center
                  </a>
                </li>
                <li>
                  <a href="/documentation" className="text-gray-300 hover:text-white transition-colors hover:underline">
                    Documentation
                  </a>
                </li>
                <li>
                  <a href="/seller-guide" className="text-gray-300 hover:text-white transition-colors hover:underline">
                    Seller Guide
                  </a>
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              {/* Test Toast Button - Add this before the footer */}
            <button
              onClick={() => showToast('Test toast message!')}
              className="fixed bottom-4 right-4 bg-purple-600 text-white px-4 py-2 rounded-lg shadow-lg z-[9998]"
            >
              Test Toast
            </button>
          {/* Bottom Footer */}
          <div className="border-t border-white/20 mt-6 lg:mt-8 pt-6 lg:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center md:justify-end space-x-4 lg:space-x-6">
              <a href="/privacy" className="text-gray-300 hover:text-white text-sm transition-colors hover:underline">
                Privacy Policy
              </a>
              <a href="/terms" className="text-gray-300 hover:text-white text-sm transition-colors hover:underline">
                Terms of Service
              </a>
              <a href="/security" className="text-gray-300 hover:text-white text-sm transition-colors hover:underline">
                Security
              </a>
            </div>
          </div>
      ...
      {/* Toast Notification - Place this at the very end, just before closing div */}
      {toast.visible && (
        <div className="fixed top-4 right-4 z-[9999] animate-in slide-in-from-right-2 duration-300">
          <div className="bg-gradient-to-r from-blue-800 to-blue-600 text-white rounded-lg shadow-2xl p-4 max-w-sm border-l-4 border-green-300">
